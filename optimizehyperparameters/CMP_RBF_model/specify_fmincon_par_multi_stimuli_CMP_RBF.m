%% This function returns the initializations, upper-bounds and lower-bounds of hyper-parameters for the RBF noise model

function fmincon_par = specify_fmincon_par_multi_stimuli_CMP_RBF(J)
    ...
    fmincon_par.noise.rho_ub = 4;%4;
    fmincon_par.noise.len_ub = .5;
