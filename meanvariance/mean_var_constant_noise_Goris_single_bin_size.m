...
function [mean_Goris_cons,variance_Goris_cons,FF_Goris_cons] = mean_var_constant_noise_Goris_single_bin_size(lambda_x,var_G,dtbin,bin_size)
...
%% Compute the statistics at each bin size
    ...
    mean_Goris_cons = (mean_temp); % average mean across all bins
    variance_Goris_cons = (variance_temp); % average variance across all bins
    FF_Goris_cons = (variance_temp./mean_temp); % average Fano Factor across all bins
